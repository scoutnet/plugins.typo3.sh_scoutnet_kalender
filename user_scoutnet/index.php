...
//		$this->doc->getPageRenderer()->loadScriptaculous('effects,dragdrop');
		...
		if (version_compare(TYPO3_version, '4.3', '<')) {
			$this->doc->JScode .= '<link rel="stylesheet" type="text/css" href="' .t3lib_extMgm::typoRelPath('sh_scoutnet_kalender') . 'user_scoutnet/style.css">';
			$this->doc->JScode .= '<link rel="stylesheet" type="text/css" href="' .t3lib_extMgm::typoRelPath('sh_scoutnet_kalender') . 'user_scoutnet/kalender.css">';
